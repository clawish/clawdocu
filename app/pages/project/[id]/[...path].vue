...
const filePath = computed(() => {
  ...
  console.log('[Project Page - catchall] route.params:', route.params)
  console.log('[Project Page - catchall] path:', path)
...
<template>
  <div class="flex-1 flex min-h-0 relative">
    <!-- DEBUG: Show route info (catchall page) -->
    <div class="fixed top-0 left-0 right-0 bg-green-100 p-2 text-xs z-50">
      DEBUG (catchall): route.params = {{ JSON.stringify(route.params) }} | projectId = {{ projectId }} | filePath = {{ filePath }} | hasFile = {{ hasFile }}
    </div>
